...
public class QueteManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(IndiceQueteEnCours > -1) // il y a une quete en cours. C'est la quete numéro : IndiceQueteEnCours
        {
            ...
            if (TabMaxObjRamasser[IndiceQueteEnCours] == TabNbObjectRammase[IndiceQueteEnCours]) // on a trouvé tous les objets, on ecrit retourner vers....
            {
